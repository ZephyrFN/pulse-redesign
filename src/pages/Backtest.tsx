  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between gap-3">
        <Button variant="ghost" size="md" icon={<ArrowLeft className="w-4 h-4" />} onClick={back} disabled={!canBack}>
          Kembali
        </Button>
        {isLast ? (
            ...
            >
              <CardBody className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <Stat size="sm" label="MaxDD" value={`${run.maxDD.toFixed(1)}%`} tone="bear" />
                </div>
              </CardBody>
            </Card>
          )
